...
svm_model = SVC(kernel='linear')  # Linear kernel for binary classification
...
class AutismTestApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Autism Spectrum Disorder (ASD) Prediction using Support Vector Classifier")
